...
namespace API.Controllers
{
    ...
    public class UsersController : BaseApiController
    {
        ...
        public async Task<ActionResult<PhotoDto>> AddPhoto(IFormFile file)
        {
            ...
            return BadRequest("Problem addign photo.");
        }
        ...
        public async Task<ActionResult> SetMainPhoto(int photoId)
        {
            ...
            if (photo.IsMain) return BadRequest("This is already your main photo."); // Checks if the photo is already the main photo
        ...
        public async Task<ActionResult> DeletePhoto(int photoId)
        {
            ...
            if (photo == null) return NotFound(); // If the photo doesn't exist, throw NotFound exception
